...
public class TestTubeRackRenderer extends TileEntitySpecialRenderer {

	private final TestTubeRackModel model;
	public static final ResourceLocation textureLocation = new ResourceLocation("sciencemc",
			"textures/blocks/testTubeRackModel.png");

	public TestTubeRackRenderer() {
		this.model = new TestTubeRackModel();
	}
