...
public class SteelCrateRenderer extends TileEntitySpecialRenderer {

	private final SteelCrateModel model;
	public static final ResourceLocation textureLocation = new ResourceLocation("sciencemc",
			"textures/blocks/steelCrateModel.png");

	public SteelCrateRenderer() {
		this.model = new SteelCrateModel();
	}
