...
public class SteelCrate extends BlockHandler implements ITileEntityProvider{
	
	private final String textureLocation = ScienceMCMod.MODID + ":" + "steelCrate"; 

	public SteelCrate(Material material,  String unlocalizedName, float hardness, String harvestToolClass,
	 ...
	 @Override
	    public TileEntity createNewTileEntity(World worldIn, int meta) {
	        return new TileEntitySteelCrate();
	    }
	 
	 @Override
		public void breakBlock(World world, int x, int y, int z, Block oldblock, int oldMetadata) {
			Random rand = new Random();
			TileEntitySteelCrate tileentity = (TileEntitySteelCrate) world.getTileEntity(x, y, z);
		...
		public boolean onBlockActivated(World world, int x, int y, int z,
			...
			if (!world.isRemote) {
		        player.openGui(ScienceMCMod.instance, ScienceMCGuiHandler.TILE_ENTITY_GUI_STEELCRATE, world, x, y, z);
		    }
		    return true;
		}
