...
public class TileEntityMicroscope extends TileEntity implements IInventory {
	...
	public Block getBlockInSlot(int index) {
		if (index < 0 || index >= this.getSizeInventory())
			return null;
		return this.inventory2[index];
	}
	...
	public String getInventoryName() {
		return this.hasCustomInventoryName() ? this.customName
				: LanguageRegistry.instance()
						.getStringLocalization("container." + ScienceMCMod.MODID + "_microscopeContainer");
	}
