...
public class TileEntityIndustrialForge extends TileEntity implements ISidedInventory {
	...
	public String getInventoryName() {
		return this.hasCustomInventoryName() ? this.localizedName : "container.industrialForge";
	}
		...
		if (itemstack == null) {
			...
			if (item instanceof ItemBlock && Block.getBlockFromItem(item) != Blocks.air) {
				...
				if (block == Blocks.spruce_stairs)
					return 300;
				if (block == Blocks.birch_stairs)
					return 300;
				if (block == Blocks.jungle_stairs)
					return 300;
				if (block == Blocks.acacia_stairs)
					return 300;
				if (block == Blocks.dark_oak_stairs)
					return 300;
	...
	public void updateEntity() {
		...
		if (!this.worldObj.isRemote) {
			...
			if (flag != this.isBurning()) {
				flag1 = true;
				IndustrialForge.updateIndustrialForgeBlockState(this.burnTime > 0, this.worldObj, this.xCoord,
