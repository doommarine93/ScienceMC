...
public class TestTubeRack extends BlockHandler implements ITileEntityProvider{
	
	private final String textureLocation = ScienceMCMod.MODID + ":" + "testTubeRack"; 

	public TestTubeRack(Material material,  String unlocalizedName, float hardness, String harvestToolClass,
	 ...
	 @Override
	    public TileEntity createNewTileEntity(World worldIn, int meta) {
	        return new TileEntityTestTubeRack();
	    }
	 
	 @Override
		public void breakBlock(World world, int x, int y, int z, Block oldblock, int oldMetadata) {
			Random rand = new Random();
			TileEntityTestTubeRack tileentity = (TileEntityTestTubeRack) world.getTileEntity(x, y, z);
		...
		public boolean onBlockActivated(World world, int x, int y, int z,
			...
			if (!world.isRemote) {
		        player.openGui(ScienceMCMod.instance, ScienceMCGuiHandler.TILE_ENTITY_GUI_TESTTUBERACK, world, x, y, z);
		    }
		    return true;
		}
