...
public class FluorescentLightTube extends BlockHandler implements ITileEntityProvider{

	private static final String __OBFID = "CL_00000325";
	private final String textureLocation = ScienceMCMod.MODID + ":" + "fluorescentLightTube";

	public FluorescentLightTube(Material material, String unlocalizedName, float hardness, String harvestToolClass,
			int harvestLevel, float resistance) {
		super(material, unlocalizedName, hardness, harvestToolClass, harvestLevel, resistance);
		this.setTickRandomly(true);
		this.setLightLevel(20F);
		this.setCreativeTab(null);
	}

	@Override
	public TileEntity createNewTileEntity(World p_149915_1_, int p_149915_2_) {
		return new TileEntityFluorescentLightTube();
	}
 ...
 * EntityLivingBase par5EntityLivingBase, ItemStack par6ItemStack) { int l =
 * MathHelper.floor_double((double) (par5EntityLivingBase.rotationYaw * 4.0F /
 * 360.0F) + 0.5D) & 3;
 * 
 * if (l == 0) { par1World.setBlockMetadataWithNotify(par2, par3, par4, 5, 2); }
 * 
 * if (l == 1) { par1World.setBlockMetadataWithNotify(par2, par3, par4, 2, 2); }
 * 
 ...
 * 
 * 
 * public class FluorescentLightTube extends BlockHandler implements
 * ITileEntityProvider {
 * 
 * private final String textureLocation = ScienceMCMod.MODID + ":" +
 * "fluorescentLightTube";
 * 
 * public FluorescentLightTube(Material material, String unlocalizedName, float
 * hardness, String harvestToolClass, int harvestLevel, float resistance) {
 * super(material, unlocalizedName, hardness, harvestToolClass, harvestLevel,
 * resistance); this.setLightLevel(20F); }
 * 
 * @Override public TileEntity createNewTileEntity(World p_149915_1_, int
 * p_149915_2_) { return new TileEntityFluorescentLightTube(); }
 * 
 * 
 * 
 */
